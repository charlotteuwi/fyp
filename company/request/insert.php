...
if(isset($_POST['cancel'])){
    //query
    $sql=mysqli_query($con, "INSERT INTO `requests` VALUES('','$contract_id','$manager', '$phone_number', 'cancel', 'pending', '$day')")or die(mysqli_error($con));
...
if(isset($_POST['renew'])){
    //query
    $sql=mysqli_query($con, "INSERT INTO `requests` VALUES('','$contract_id','$manager', '$phone_number', 'renew', 'pending', '$day')")or die(mysqli_error($con));
...
if(isset($_POST['update_information'])){
    $sql=mysqli_query($con, "INSERT INTO `requests` VALUES('','$contract_id','$manager', '$phone_number', 'update_information', 'pending', '$day')")or die(mysqli_error($con));

    if($sql){
        header('Location: ../../notification.php?notification=Your request to update_information  have been recorded');
    //We insert into the db some cancel request information
}
}
?>