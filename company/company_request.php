            ...
            <div class="flex p-4 h-full items-center">
                <div class="w-full bg-blue-200 rounded-l border-r p-4">
                    ...
                    <form method="POST" action="request/insert.php">
                        ...
                        if ($stmt = $con->prepare('SELECT contract_id, company_name, phone_number FROM companycontracts WHERE contract_id = ?')) {
                            ...
                            $stmt->store_result();
                            if ($stmt->num_rows > 0) {
                                $stmt->bind_result($contract_id, $company_name, $phone_number);
                                $stmt->fetch();

                        ?>
                                <input type="hidden" name="contract_id" value="<?php echo $contract_id; ?>">
                                <input type="hidden" name="manager" value="<?php echo $company_name; ?>">
                    ...
                    <table class="w-full text-xs">
                        ...
                        <tr class="bg-white text-gray-900 font-medium border-l border-r border-gray-900">
                            ...
                            <td class="p-2 ml-2 border-r border-gray-900">Company Name </td>
                            <td class="p-2 ml-2 border-r border-gray-900">Phone Number </td>
                            <td class="p-2 ml-2 border-r border-gray-900">Action </td>
                            <td class="p-2 ml-2 border-r border-gray-900">Company Reason </td>
                    ...
                    <div class="mt-4">
                        <table class="w-full text-xs">
                            ...
                            <tr class="bg-green-600 shadow font-medium text-white border-l border-r border-gray-900">
                                ...
                                <td class="p-2 ml-2">Company Name </td>
                                <td class="p-2 ml-2">Phone Number</td>
                                <td class="p-2 ml-2">Action</td>
                                <td class="p-2 ml-2">Company Reason</td>
