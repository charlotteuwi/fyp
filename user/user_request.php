            ...
            <div class="flex p-4 h-full items-center">
                <div class="w-full bg-blue-200 rounded-l border-r p-4">
                    ...
                    <form method="POST" action="request/insert.php">
                        ...
                        if ($stmt = $con->prepare('SELECT contract_id, client_name, phone_number FROM usercontracts WHERE contract_id = ?')) {
                            ...
                            $stmt->store_result();
                            if ($stmt->num_rows > 0) {
                                $stmt->bind_result($contract_id, $client_name, $phone_number);
                                $stmt->fetch();
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="p-4 ml-4">Client_Name </td>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td class="p-4 ml-4"><?php echo $client_name; //selected as manager ?> </td>
                    ...
                    <table>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td class="p-4 ml-4"><?php echo $contract_id; ?> </td>
                                    <td class="p-4 ml-4"><?php echo $client_name; ?> </td>
                                    <td class="p-4 ml-4"><?php echo $phone_number; ?> </td>
                                    <td class="p-4 ml-4"><?php echo $action; ?> </td>
                                    <td class="p-4 ml-4"><?php echo $status; ?> </td>
                                    <td class="p-4 ml-4"><?php echo $date; ?> </td>
