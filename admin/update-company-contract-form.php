			...
			<div class="flex-wrap mx-80 mt-20">
				...
				?>
					...
					<form action="company-contract/update.php" method="POST">
						...
						<div class="row">
							<div class="col"><input type="text" class="form-control" name="company_name" value="<?php echo $array['company_name']; ?>" required="true">
							</div>
						</div>
						<div class="form-group">
							<input type="text" class="form-control" name="tin_number" value="<?php echo $array['tin_number']; ?>" required="true">
						</div>

						<div class="form-group">
							<input type="text" class="form-control" name="description" value="<?php echo $array['description']; ?>" required="true">
						</div>
						<div class="form-group">
							<input type="text" class="form-control" name="manager" value="<?php echo $array['manager']; ?>" required="true">
						</div>
						<div class="form-group">
							<input type="number" class="form-control" name="phone_number" value="<?php echo $array['phone_number']; ?>" required="true">
						</div>
						<div class="form-group">
							<input type="text" class="form-control" name="address" value="<?php echo $array['address']; ?>" required="true">
						</div>
						<div class="form-group">
							<input type="date" class="form-control" name="start_date" value="<?php echo $array['start_date']; ?>" required="true">
						</div>
						<div class="form-group">
							<input type="date" class="form-control" name="end_date" value="<?php echo $array['end_date']; ?>" required="true">
						</div>
						<div class="form-group">
