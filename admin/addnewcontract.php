							...
							<div class="flex p-4">
								...
								<div class="w-3/4 bg-blue-200 rounded-r border-l border-red-400 p-4">
									Contract Information
											...
											<div class="w-full mt-2">
												<input class="w-full shadow rounded px-1 py-2" type="text" name="phone_campany" required="" minlength="12" min="2507200000" placeholder="0700000000"></div>
										</div>
										
										</div>
										 <div class="w-full mt-2">
												<input class="w-full shadow rounded px-1 py-2" type="submit" name="save" value="submit" class="border-b border-gray-900 bg-red-600 rounded-full px-4 py-1 w-64 text-white"></div>	
									</form>		
										</div>							
								</div>
							</div>
