...
<body class="bg-gray-100">
    <div>
        ...
        <button onclick="printDiv()" class="flex-wrap w-full focus:outline-none font-bold items-center justify-center mt-2 text-lg rounded shadow py-2">
            <p class="w-full text-center"><i class="fas fa-print mr-2"></i> All Active Contracts</p>
        ...
        <div id="allcontracts"  class="w-full px-16 mt-8 flex items-center justify-center mb-16">
            ...
            <table class="w-3/4 bg-white p-2 rounded shadow" cellspacing="10">
                ...
                $query = "select * from companycontracts where status='ACTIVE'"; // Fetch all the records from the table address
                ...
                $query = "SELECT * from usercontracts WHERE `status`='ACTIVE'"; // Fetch all the records from the table address
                $result = mysqli_query($con, $query);
        ...
        <script>
            function printDiv() {
                ...
                a.document.write('<h1>ECAS All Active Contracts <br>');
