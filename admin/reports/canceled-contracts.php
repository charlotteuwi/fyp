...
<body class="bg-gray-100">
    <div>
        ...
        <button onclick="printDiv()" class="flex-wrap w-full focus:outline-none font-bold items-center justify-center mt-2 text-lg rounded shadow py-2">
            <p class="w-full text-center"><i class="fas fa-print mr-2"></i> All Canceled Contracts</p>
        ...
        <div id="allcontracts"  class="w-full px-16 mt-8 flex items-center justify-center mb-16">
            ...
            <table class="w-3/4 bg-white p-2 rounded shadow" cellspacing="10">
                <tr class="bg-gray-900 text-white p-2 border-b border-gray-900 rounded-r-md rounded-l-md" colspan="6">
                    ...
                    <th class="p-2 text-left"> Contract Type </th>
                </tr>

                <?php
                include_once('../../resources/connection.php');

                $query = "select * from companycontracts where status='cancel'"; // Fetch all the records from the table address
                ...
                while ($array = mysqli_fetch_array($result)) { ?>
                    ...
                    <tr class="border-b border-gray-900">
                        ...
                        <td class="p-2 text-left"><?php echo $array['phone_number'];
                                                    ?></td>
                        <td class="p-2 text-left"><?php echo $array['start_date'];
                                                    ?></td>
                        <td class="p-2 text-left"><?php echo $array['end_date'];
                                                    ?></td>
                        <td class="p-2 text-left"><?php echo $array['address'];
                                                    ?></td>
                        <td class="p-2 text-left"><?php echo 'Company';
                                                    ?></td>
                    </tr>
                <?php
                }
                $query = "SELECT * from usercontracts WHERE `status`='cancel'"; // Fetch all the records from the table address
                $result = mysqli_query($con, $query);
                ...
                while ($array = mysqli_fetch_array($result)) { ?>
                    <tr class="border-b border-green-600">
                        <td class="p-2 text-left"><?php echo $array['contract_id'];
                                                    ?></td>
                        <td class="p-2 text-left"><?php echo $array['employee_name'];
                                                    ?></td>
                        <td class="p-2 text-left"><?php echo $array['phone_number'];
                                                    ?></td>
                        <td class="p-2 text-left"><?php echo $array['start_date'];
                        ...
                        <td class="p-2 text-left"><?php echo $array['address'];
                                                    ?></td>
                        <td class="p-2 text-left"><?php echo 'Employee';
                                                    ?></td>
                    </tr>
                <?php
                }
        ...
        <script>
            function printDiv() {
                ...
                a.document.write('<h1>ECAS All Canceled Contracts <br>');
