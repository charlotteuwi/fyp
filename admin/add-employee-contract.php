...
<a href="">
			...
			<div class="w-full items-center justify-center">
				<div class="flex justify-between border-b border-gray-900 bg-red-600 px-2 py-4 w-full text-white">
					<p class="font-bold">Form to Add New Employee contracts </p>
				...
				<div class="flex p-4">
					<div class="w-3/4 h-2/4 bg-blue-200 rounded-l border-r border-red-800 p-4">
						<p class="font-bold">employee Information</p>
						<form action="employee-contract/insert.php" method="POST" enctype="multipart/form-data">
